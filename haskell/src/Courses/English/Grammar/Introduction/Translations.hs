...
translations4_expressions = expandTranslationGenerator $ combineGeneratorsUniformly [sutra, lojbo, pendo, gleki, melbi, others] where
    sutra = generatorFromList
        [ (["lo sutra prenu"], ["The fast person."])
        , (["lo sutra vecnu"], ["The fast seller."])
        , (["lo sutra te vecnu"], ["The fast buyer."])
        , (["lo sutra tavla"], ["The fast speaker."])
        , (["lo sutra ctuca"], ["The fast teacher."])
        , (["lo sutra gerku"], ["The fast dog."])
        , (["lo sutra mlatu"], ["The fast cat."])
        ]
    lojbo = generatorFromList
        [ (["lo lojbo prenu"], ["The Lojbanic person."])
        , (["lo lojbo dunda"], ["The Lojbanic donor."])
        , (["lo lojbo vecnu"], ["The Lojbanic seller."])
        , (["lo lojbo te vecnu"], ["The Lojbanic buyer."])
        , (["lo lojbo tavla"], ["The Lojbanic speaker."])
        , (["lo lojbo ctuca"], ["The Lojbanic teacher."])
        , (["lo lojbo gerku"], ["The Lojbanic dog."])
        , (["lo lojbo mlatu"], ["The Lojbanic cat."])
        ]
    pendo = generatorFromList
...
translations4_sentences = expandTranslationGenerator $ combineGeneratorsUniformly [adverb, adjective] where
    ...
    adjective = combineGeneratorsUniformly [pendo, gleki] where
        lojbo = generatorFromList
            -- tavla (mi)
            [ (["mi tavla lo lojbo prenu", "mi tavla lo prenu poi lojbo"], ["I talked to the Lojbanic person."])
            , (["mi tavla lo lojbo dunda", "mi tavla lo dunda poi lojbo"], ["I talked to the Lojbanic donor."])
            , (["mi tavla lo lojbo vecnu", "mi tavla lo vecnu poi lojbo"], ["I talked to the Lojbanic seller."])
            , (["mi tavla lo lojbo te vecnu", "mi tavla lo te vecnu poi lojbo"], ["I talked to the Lojbanic buyer."])
            , (["mi tavla lo lojbo ctuca", "mi tavla lo ctuca poi lojbo"], ["I talked to the Lojbanic teacher."])
            ]
        pendo = generatorFromList
            -- tavla (mi)
