...
course = Course "grammar-intro_eng" title shortDescription (Just longDescription) (Just credits) style englishDictionary lessons where
    ...
    lessons = [lesson1, lesson2, lesson3, lesson4, lesson5, lesson6, lesson7, checkpoint1to7, lesson9, lesson10, lesson11, lesson12, checkpoint9to12, lesson14, lesson15, lesson16, lesson17, lesson18, checkpoint14to18]
