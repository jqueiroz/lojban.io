...
Right lecture1to6 = buildDocumentFromMarkdownCode $(embedStringFile "resources/courses/english/grammar/introduction/lectures/checkpoint_01to06.md")

-- | Lecture for the eighth lesson.
lecture8 :: P.Pandoc
Right lecture8 = buildDocumentFromMarkdownCode $(embedStringFile "resources/courses/english/grammar/introduction/lectures/08.md")
...
Right lecture8to12 = buildDocumentFromMarkdownCode $(embedStringFile "resources/courses/english/grammar/introduction/lectures/checkpoint_08to12.md")
...
plan8 :: P.Pandoc
Right plan8 = buildDocumentFromMarkdownCode $(embedStringFile "resources/courses/english/grammar/introduction/planning/08.md")
