...
translationsByExpression01 = loadTranslationsByExpressionFromYamlCode $(embedStringFile "resources/decks/english/brivla/sentences/01_easy.yaml")

-- | Translations for the corresponding lesson.
translationsByExpression02 :: TranslationsByExpression
translationsByExpression02 = loadTranslationsByExpressionFromYamlCode $(embedStringFile "resources/decks/english/brivla/sentences/02_easy.yaml")

-- | Translations for the corresponding lesson.
translationsByExpression03 :: TranslationsByExpression
translationsByExpression03 = loadTranslationsByExpressionFromYamlCode $(embedStringFile "resources/decks/english/brivla/sentences/03_easy.yaml")

-- | Translations for the corresponding lesson.
translationsByExpression04 :: TranslationsByExpression
translationsByExpression04 = loadTranslationsByExpressionFromYamlCode $(embedStringFile "resources/decks/english/brivla/sentences/04_easy.yaml")

-- | Translations for the corresponding lesson.
translationsByExpression05 :: TranslationsByExpression
translationsByExpression05 = loadTranslationsByExpressionFromYamlCode $(embedStringFile "resources/decks/english/brivla/sentences/05_easy.yaml")
