...
Often, but not always, bridi with _se_-constructs are translated to sentences with the passive voice, since the x_1 is often the object performing the action.
...
|Sentence|Translation|
|--------|-----------|
|The gift is beautiful.|<span class="spoiler-answer">lo se dunda ku melbi</span>|
|I like the teaching method.|<span class="spoiler-answer">mi nelci lo xe ctuca ku</span>|
|The dog is friendly.|<span class="spoiler-answer">lo gerku ku pendo</span>|
