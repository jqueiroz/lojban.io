...
In this case, _jai_ simply converts the selbri such that the sumti in the x_1 gets a tu'a in front of it: _do jai mukti_ = _tu'a do mukti_.
...
<span class="definition-head">lerci</span> convert tense/modal (tagged) place to 1st place; 1st place moves to extra FA place (fai).
