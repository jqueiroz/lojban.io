...
But this is not required: _xu_ may go anywhere in a sentence, and it gives emphasis to preceding word (or construct).
...
The word _go'i_ just repeats the previous bridi, and hence the two approaches that we saw are equivalent.
