...
lesson1 :: Lesson
lesson1 = Lesson "Pure emotions 1" exercises1 lecture1 plan1

-- | Second lesson: Propositional emotions 1.
lesson2 :: Lesson
lesson2 = Lesson "Propositional emotions 1" exercises2 lecture2 plan2

-- | Third lesson: Attitudinal modifiers 1
lesson3 :: Lesson
lesson3 = Lesson "Attitudinal modifiers 1" exercises3 lecture3 plan3
