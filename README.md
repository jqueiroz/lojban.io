...
#### 1. You may define the course entirely in Haskell
  ...
  There are also many useful utility functions in [Study.Framework.ExerciseGenerators](https://lojban.io/documentation/lojbanios-0.1.0.0/Study-Framework-ExerciseGenerators.html) for building high-level exercise generators from relatively low-level primitives, such as individual translations or words.
  ...
  Examples are [generateTranslationExercise](https://lojban.io/documentation/lojbanios-0.1.0.0/src/Study.Framework.ExerciseGenerators.html#generateTranslationExercise), [generateBlacklistedWordTranslationExercise](https://lojban.io/documentation/lojbanios-0.1.0.0/src/Study.Framework.ExerciseGenerators.html#generateBlacklistedWordTranslationExercise), [generateGrammaticalClassExercise](https://lojban.io/documentation/lojbanios-0.1.0.0/src/Study.Framework.ExerciseGenerators.html#generateGrammaticalClassExercise), [generateFillingBlanksExerciseByAlternatives](https://lojban.io/documentation/lojbanios-0.1.0.0/src/Study.Framework.ExerciseGenerators.html#generateFillingBlanksExerciseByAlternatives), [generateFillingBlanksExerciseByExpression](https://lojban.io/documentation/lojbanios-0.1.0.0/src/Study.Framework.ExerciseGenerators.html#generateFillingBlanksExerciseByExpression), and several others.
  ...
  * the translation manipulation utilities in [Study.Framework.TranslationUtils](https://lojban.io/documentation/lojbanios-0.1.0.0/Study-Framework-TranslationUtils.html);
